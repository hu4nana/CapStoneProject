...
namespace KurotoriTools
{
    ...
    public class PhysBoneRemapper : IComponentRemapper
    {
        ...
        public void Remap(BonePathInfo assembledPathInfo)
        {
            ...
            assembledComponent.version = component.version;
            ...
            assembledComponent.stretchMotion = component.stretchMotion;
            assembledComponent.stretchMotionCurve = KurotoriUtility.CopyAnimationCurve(component.stretchMotionCurve);
            ...
            assembledComponent.maxSquish = component.maxSquish;
            assembledComponent.maxSquishCurve = KurotoriUtility.CopyAnimationCurve(component.maxSquishCurve);
            ...
            assembledComponent.snapToHand = component.snapToHand;

            assembledComponent.parameter = component.parameter;
            assembledComponent.isAnimated = component.isAnimated;
            assembledComponent.resetWhenDisabled = component.resetWhenDisabled;
